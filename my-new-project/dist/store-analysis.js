...
pythonProcess.on('close', (code) => {
    ...
    results.daily_routes.forEach((route) => {
        ...
        if (route.failed_orders > 0)
            report += ` | ${route.failed_orders} failed`;
        if (route.pending_orders > 0)
            report += ` | ${route.pending_orders} pending 🚨`;
...
//# sourceMappingURL=store-analysis.js.map